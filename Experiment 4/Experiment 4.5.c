//Experiment 4.5. Ramanujan Number is the smallest number that can be expressed as the sum of two
//cubes in two different ways. WAP to print all such numbers up to a reasonable limit.
//Example of Ramanujan number: 1729 12^3 + 1^3 and 10^3 + 9^3. for a number L=20(thatis limit) */
